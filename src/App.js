...
// Initialize Firebase
  var config = {
    apiKey: "AIzaSyBUNsuLTpNhFAYhDJGNfnE3Oh_1_OLynGQ",
    authDomain: "simplesurvey-d7da4.firebaseapp.com",
    databaseURL: "https://simplesurvey-d7da4.firebaseio.com",
    projectId: "simplesurvey-d7da4",
    storageBucket: "simplesurvey-d7da4.appspot.com",
    messagingSenderId: "543697009931"
  };
...
class App extends Component {
  ...
  handleQuestionSubmit (event) {
    ...
    this.setState({
      submitted:true, function(){ console.log('Questions Submitted...')}
    });
    event.preventDefault();
  }
    ...
    if (this.state.name && this.state.submitted === false) {
      ...
      questions = <span>
        ...
        <form onSubmit={this.handleQuestionSubmit.bind(this)}>
          ...
          <div>
            <label>What is your favorite time of the day?</label><br />
